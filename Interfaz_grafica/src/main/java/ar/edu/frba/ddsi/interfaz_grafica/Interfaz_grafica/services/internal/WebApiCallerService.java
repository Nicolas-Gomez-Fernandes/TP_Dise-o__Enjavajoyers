package ar.edu.frba.ddsi.interfaz_grafica.Interfaz_grafica.services.internal;

import ar.edu.frba.ddsi.interfaz_grafica.Interfaz_grafica.dtos.auth.AuthResponseDTO;
import ar.edu.frba.ddsi.interfaz_grafica.Interfaz_grafica.dtos.auth.RefreshTokenDTO;
...
public class WebApiCallerService {
  ...
  /**
   * Ejecuta una llamada HTTP GET que retorna una lista sin autorizacion
   */
    public <T> java.util.List<T> getListNoAuth(String url, Class<T> responseType) {
        try {
            return webClient
                .get()
                .uri(url)
    ...
    /**
     * Ejecuta una llamada HTTP GET sin autorización (sin usar sesión)
     */
    public <T> T getNoAuth(String url, Class<T> responseType) {
        try {
            return webClient
                .get()
                .uri(url)
