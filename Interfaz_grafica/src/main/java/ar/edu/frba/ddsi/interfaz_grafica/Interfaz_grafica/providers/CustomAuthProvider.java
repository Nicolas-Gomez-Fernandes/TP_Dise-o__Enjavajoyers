package ar.edu.frba.ddsi.interfaz_grafica.Interfaz_grafica.providers;
...
public class CustomAuthProvider implements AuthenticationProvider {
  ...
  private final GestionUsuariosService externalAuthService;

  public CustomAuthProvider(GestionUsuariosService externalAuthService) {
  ...
  public Authentication authenticate(Authentication authentication) throws AuthenticationException {
    ...
    try {
      ...
      RolesYPermisosDTO rolesPermisos = externalAuthService.getRolesPermisos(authResponse.getAccessToken());
