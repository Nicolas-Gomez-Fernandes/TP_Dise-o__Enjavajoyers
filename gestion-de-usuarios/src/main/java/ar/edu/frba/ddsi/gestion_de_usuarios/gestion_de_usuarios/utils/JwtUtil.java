package ar.edu.frba.ddsi.gestion_de_usuarios.gestion_de_usuarios.utils;
...
public class JwtUtil {
  ...
  public static String generarAccessToken(String username) {
    return Jwts.builder()
        .setSubject(username) // a quien va dirigido
        .setIssuer("gestion-alumnos-server") // quien lo genera
        .setExpiration(new Date(System.currentTimeMillis() + ACCESS_TOKEN_VALIDITY)) // tiempo de validez
        .signWith(key) // algoritmo de cifrado
        .compact();
  }
